...
/// Tiny Keychain wrapper shared by host app + keyboard (same access group via App Group is not
/// always available for keychain; we store under the standard service and also mirror a flag
